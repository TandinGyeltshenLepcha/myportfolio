...
const projects = [
  {
    ...
    description: "I turned passive browsing into an experience people actually stay for. This interactive game platform drove deeper engagement through immersive UI and narrative-driven design — proof that I don't just build interfaces, I build moments.",
    tag: "Game UI/UX",
    tagColor: "#14532d",
  ...
  },
  {
    ...
    description: "I made mythology tangible. Every material choice, every form decision communicates a story — no caption needed. This is the kind of conceptual depth I bring to every visual problem: design that earns a second look.",
    tag: "Concept Art",
    tagColor: "#7c2d12",
  ...
  },
  {
    ...
    description: "I built a game system where skill beats luck — every time. Clear visual hierarchy, tight mechanical loops, and satisfying mastery curves. If you need someone who thinks in systems and ships polished results, this is what that looks like.",
    tag: "Game Design",
    tagColor: "#7c0a02",
